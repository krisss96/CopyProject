...
├── assets/
│   ├── 9.png                  # Game logo 
│   ├── runner.png             # Runner icon for battle page
...
1. **Mixkit Files:**  
   Visit https://mixkit.co/license/ to review Mixkit's free license terms.

2. **ZapSplat File:**  
   Visit https://www.zapsplat.com/license-type/ to review ZapSplat's license terms based on your account type.
